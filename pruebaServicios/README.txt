...
a persistence unit "pruebaServiciosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaServicios/pom.xml":
...
artifact ("pruebaServicios.war") is already built. You can build
